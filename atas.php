    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="infomasi-pendaftaran.php">Informasi Pendaftaran</a></li>

          <li><a class="getstarted scrollto" href="formulir_pendaftaran.php">Formulir Pendaftaran</a></li>
        </ul>
